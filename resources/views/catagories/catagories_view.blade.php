      ...
      <div data-aos="fade-up">
        <div class="section-title">
          ...
          <h2>
            ...
            {{$catagory->catagory??'No Questions Available...'}} ?</h2>

          <p>Final Year Students problems related to {{$catagory->catagory??null}}</p>
        </div>
        ...
        <div class="faq-list">
          ...
          <ul id="myList">
            ...
            <li data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="row">
                  <a href="{{ route('posts.show', $post->id) }}" style="font-size:12px"><Br>View Question</a>


@if (  Auth::user()->name  == $post->added_by )

    <a href="{{ route('posts.edit', $post->id) }}" style="font-size:12px"><Br>Edit</a>
...
<br>
         <a href="" style="font-size:12px" onclick="this.closest('form').submit();return false;">Delete</a>
