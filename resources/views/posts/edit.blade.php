  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="{{route('home')}}">WatchQuestions</a></li>
    ...
    <section id="faq" class="faq section-bg">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>You can change your question which you posted recently !</p>
        </div>
              ...
              <div id="faq-list-1" class="collapse show" data-parent=".faq-list">
                <p>
                    ...
                    <div class="row justify-content-center">
                         {{-- you can change column value here --}}
                        <div class="col-lg-11">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('posts.update', $posts->id) }}" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <br/>
                                            Update Catagory:&nbsp;
                                              <select name="catagory" class="form-select form-select-sm" aria-label=".form-select-sm example">
                                                    <option selected disabled>Update Catogory</option>
...
&nbsp; &nbsp;&nbsp;&nbsp; <span style="font-size:12px;">Selected: &nbsp;</span> <span style="color:rgb(63, 104, 190); ">{{$posts->catagory}}</span>
                             ...
                             <textarea id="summernote" name="body" placeholder="Place explanation to your question here" required> {{$posts->body}} </textarea>
                                            <script>
    ...
    ['table', ['table']],
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn btn-primary" style="background-color:rgb(69, 137, 214)">Post Edited Question</button>
