    ...
    <section id="faq" class="faq section-bg">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>You can ask your question here and people can reply and will be able to answer your question !</p>
        </div>
...
<br/>
Select Catagory:&nbsp;
                                       <select name="catagory" class="form-select form-select-sm" aria-label=".form-select-sm example" required>
                                                <option selected disabled>Select Catogory</option>
                             ...
                             <textarea id="summernote" name="body" placeholder="Place explanation to your question here" required> </textarea>
                                            <script>
    ...
    ['table', ['table']],
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn btn-primary" style="background-color:rgb(69, 137, 214)">Post Question</button>
